                ...
                <nav>
                    <ul id="menu">
                        ...
                        <li style="float: right;">
                            <a>Benvenuto <%=username%></a>
                        </li>
                        <li style="float: right;">
                            <a href="logout.jsp?link=<%=urlRet %>"> Logout </a>
                        </li>
                        <%
                            }
                        %>
            ...
            <div id="contenitore">
                ...
                <form action="AddProdotto" method="post">
                    <table align="center" style="width:300px; height:250px">
                        ...
                        <tr>
                            <td colspan=2>Inserisci codice prodotto:</td>
                        </tr>
                        <tr>
                            <td colspan=2>
                        ...
                        <tr>
                            <td colspan=2>Inserisci prezzo: (Utilizza il "." per dividere i decimali)</td>
                        </tr>
                        <tr>
                            <td colspan=2>
                        ...
                        <tr>
                            <td colspan=2>Aggiungi Descrizione:</td>
                        </tr>
                        <tr>
                            <td colspan=2>
                                <textarea placeholder="Ent" name="descrizione" required maxlength="1024" style="width:100%; height:100%" rows="4"></textarea>
                            </td>
                        </tr>
                        <tr>
                            <td colspan=2>Indica la Tipologia del prodotto:</td>
                        </tr>
                        <tr>
                            <td colspan=2>
                                <select name="tipo">
