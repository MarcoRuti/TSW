...
<div class="divContorno">
    <div id="contenitore">
        ...
        <p>Questa pagina Ë riservata solo ad account administrator. Torna alla <a href="index.jsp">home</a> per loggarti.</p>
        <%
        }
        else if(isAdmin == 0) { //isAdmin sar‡ = 0 quando nessun account Ë al momento collegato
        %>
        <h2>ACCESSO NON AUTORIZZATO!</h2>
