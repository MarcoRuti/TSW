...
<body>
    ...
    <div class="divContorno">
                ...
                <tr class="adminTable">
                    <td width="50%" class="adminTable">
                        <fieldset>
                            ...
                            <p>
                                <a href="DynamicTab?tab=adminaccount&action=<%=action%>">Gestisci gli account Amministratore</a>
                            </p>
                            <!-- permette modifica e rimozione nella pagina aperta -->

                            <p>
                                <a href="newAdminAccountForm.jsp">Aggiungi nuovo Amministratore</a>
                            </p>
                        </fieldset>
                    </td>
                    <td width="50%" class="adminTable">
                        <fieldset>
                            ...
                            <p>
                                <a href="DynamicTab?tab=cliente&action=<%=action%>">Gestisci gli account Cliente</a>
                            </p>
                            <p>
                                <a href="newCliente.jsp">Aggiungi Cliente</a>
                            </p>
                        </fieldset>
                    </td>
                </tr>
                <tr class="adminTable">
                    <td width="50%" class="adminTable">
                        <fieldset>
                            ...
                            <p>
                                <a href="DynamicTab?tab=prodotto&action=<%=action%>">Gestisci lista prodotti</a>
                            </p>
                            <p>
                                <a href="newProdotto.jsp">Aggiungi prodotto</a>
                            </p>
                        </fieldset>
                    </td>
                    <td width="50%" class="adminTable">
                        <fieldset>
                            ...
                            <p>
                                <a href="DynamicTab?tab=ordine&action=<%=action%>">Gestisci lista ordini</a>
                            </p>
                        </fieldset>
                    </td>
                </tr>
        ...
        //QUESTO ISCLIENTE NON VIENE LETTO POICHè SE ENTRI CON "DARIOSCOLA" ESEGUE L'IF DOVE STA SCRITTO ISADMIN=0
            else if(isCliente == 1) {
                //accesso alla pagina con account locale
            %>
            ...
            <%
                ...
                //isAdmin sarà = 0 quando nessun account è al momento collegato
            %>
