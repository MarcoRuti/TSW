...
<head>
    ...
    <title>Aggiungi un nuovo account Amministratore</title>
...
<h2 align="center">Aggiungi un nuovo Account Amministratore</h2>

<div class="divContorno">
    <div id="contenitore">
        <form action="AddCAdminAccount" method="post">
