...
int codice;
double prezzo;
List<ProdottoBean> arrayProdotti;
String data_inizio;
String data_fine;
...
public OffertaBean() {
	...
	data_inizio = "";
	data_fine = "";
	arrayProdotti = new ArrayList<ProdottoBean>();
}
...
public void setArrayProdotti(ArrayList<ProdottoBean> array) {
	arrayProdotti=array;
}

public ArrayList<ProdottoBean> getProdottiInOfferta(){
	return (ArrayList<ProdottoBean>) arrayProdotti;
}
